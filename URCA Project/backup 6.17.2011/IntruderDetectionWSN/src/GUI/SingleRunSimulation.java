    ...
    implements Runnable
{
    ...
    public void drawDemo(int w, int h, Graphics2D g2) {
        ...
        //
        java.lang.Float posX = (intruderPosX + iter)/2;
        java.lang.Float posY = intruderPosY/2 + 50;

        if ( iter > distanceTraveled + 100 )
            posX = 50.5f + (intruderPosX + distanceTraveled.floatValue())/2.0f;
        ...
        g2.draw(new Line2D.Float(intruderPosX.floatValue()/2, intruderPosY.floatValue()/2 + 50,
                posX, posY));       
    }
