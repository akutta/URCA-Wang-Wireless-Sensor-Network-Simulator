...
public class BaseStation extends Node {
    ...
    public void Update() {
        ...
        if ( sType == SensingTypeEnum.K_INDIVIDUAL ) {
            ...
            // If we have recieved at least enough possible detections
            if ( curNode >= gsv.getK() ) {
    ...
    public void setSensingType(SensingTypeEnum sensingType, Integer numNodes) {
        sType = sensingType;
        if ( sType == SensingTypeEnum.K_SIMULTANEOUS )
            nodesWithDetection = new Node[numNodes];
    }
    ...
    public void Initialize() {
        ...
        posX = gsv.getBoardWidth();
        posY = gsv.getBoardHeight() / 2;
